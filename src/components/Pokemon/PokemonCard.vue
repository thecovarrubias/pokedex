<template>
  <article
    class="h-96 lg:h-52 flex flex-col-reverse lg:flex-row lg:justify-between rounded border border-gray-100 p-4 bg-white transition-all hover:drop-shadow-xl relative"
  >
